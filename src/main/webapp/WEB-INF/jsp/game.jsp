...
<form class="form-inline" id="buttons-game">
    <div class="form-group">
        <label for="connect">WebSocket connection:</label>
        <button id="connect" class="btn btn-default" type="submit">Connect</button>
        <button id="disconnect" class="btn btn-default" type="submit" disabled="disabled">Disconnect</button>
        <button id="send" class="btn btn-default" type="submit">Send</button>
        <button id="reset" class="btn btn-default" type="submit" disabled="disabled">Reset Game</br>(Only when you are
            alone in the room)
        </button>
        <button onclick="redirectToHistory()">Obejrzyj powtórkę</button>
    </div>
</form>
...
<form class="form-inline" id="buttons-replay" style="display: none;">
    <div class="form-group">
        <label for="connect">WebSocket connection:</label>
        <button id="next" class="btn btn-default" type="submit">Poprzedni ruch</button>
        <button id="disconnect" class="btn btn-default" type="submit" disabled="disabled">Następny ruch</button>
    </div>
</form>
